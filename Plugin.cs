...
namespace PvPModes
{
...
#endif
	{
		...
		private static ManualLogSource PluginLog;
		...
		{
			/// 1) After the game has been bootstrapped, it comes here.
			System.Console.WriteLine("Null Test..");
			Initialize();
			System.Console.WriteLine("Does it finish here?..");
		}
	}
}
