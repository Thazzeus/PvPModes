    ...
    public class CommandHandler
    {
        ...
        public static void HandleCommands(VChatEvent ev)
        {
            ...
            foreach (Type type in types)
            {
                ...
                P_Cache.command_Cooldown.TryGetValue(ev.User.PlatformId, out float last_Command);
                ...
                P_Cache.command_Cooldown[ev.User.PlatformId] = getCurrentTime + delay_Cooldown;
