...
namespace PvPModes.Utils
{
    ...
    {
        //-- P_Cache (Wiped on plugin reload, server restart, and shutdown.)

        //-- -- Player P_Cache
        public static Dictionary<FixedString64, PlayerData> NamePlayerP_Cache = new();
        public static Dictionary<ulong, PlayerData> SteamPlayerP_Cache = new();
        ...
        //-- -- PvP System
        public static Dictionary<Entity, LevelData> PlayerLevelP_Cache = new();
